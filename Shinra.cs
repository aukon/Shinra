...
namespace ShinraCo
{
    public class Shinra : CombatRoutine
    {
        ...
        public override Composite CombatBehavior
        {
            get
            {
                return new Decorator(r => Core.Player.HasTarget,
                                     new PrioritySelector(new Decorator(r => WorldManager.InPvP && Settings.EnablePVP, new ActionRunCoroutine(ctx => MyRotation.CombatPVP())),
        ...
        public override Composite CombatBuffBehavior
        {
            ...
            {
                return new Decorator(r => Core.Player.HasTarget,
                                     new PrioritySelector(new Decorator(r => !WorldManager.InPvP, new ActionRunCoroutine(ctx => MyRotation.CombatBuff()))));
        ...
        public override Composite PullBehavior
        {
            ...
            {
                return new Decorator(r => Core.Player.HasTarget,
                                     new PrioritySelector(new Decorator(r => !WorldManager.InPvP, new ActionRunCoroutine(ctx => MyRotation.Pull()))));
